    ...
    <div class="container">
        <form class="form-container" method="POST" action="{{ route('admin.login.submit') }}">
             @csrf
                ...
                <br>
                <label class="form-row">
                    <input type="checkbox" id="subscribe" name="subscribe"> saya menyetujui
                </label>
                <div class="form-row">
        ...
        <svg viewBox="0 0 1000 1000" stroke-linecap="round" stroke-linejoin="round">
            ...
            <g class="grabbing-hand">
                ...
                <path class="grabbing-hand-finger-open"
            ...
            <g class="spray-hand-container">
                <g class="pushing-hand">
                    ...
                    <g>
                        ...
                        <rect x="3.9" y="18.4" width="8.4" height="21.47" rx="3.7"
                ...
                <g class="sprayer">
                    <g class="sprayer-head">
                        ...
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="22.4" y1="14.76" x2="74.27"
                            y2="25.2" />
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="21.51" y1="21.12"
                            x2="74.27" y2="25.2" />
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="21.44" y1="28.26"
                            x2="74.27" y2="25.2" />
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="22.37" y1="35.54"
                            x2="74.27" y2="25.2" />
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="24.21" y1="42.36"
                            x2="74.27" y2="25.2" />
                        <line class="spray-line" stroke="#777777" stroke-dasharray="8 5" x1="24.31" y1="7.78" x2="74.27"
                            y2="25.2" />
            ...
            <g class="grabbing-hand">
                <g fill="#ffffff">
                    <rect class="grabbing-hand-finger-closed" x="44.79" y="13.38" width="8.42" height="22.15" rx="3.67"
                        transform="translate(20.57 71.26) rotate(-85.25)" />
                    <rect class="grabbing-hand-finger-closed" x="44.08" y="39.17" width="8.42" height="21.47" rx="3.67"
                        transform="translate(-5.44 93.9) rotate(-85.25)" />
                    <rect class="grabbing-hand-finger-closed" x="45.68" y="30.71" width="8.42" height="22.57" rx="3.67"
                        transform="matrix(0.08, -1, 1, 0.08, 3.91, 88.24)" />
                    <rect class="grabbing-hand-finger-closed" x="44.98" y="22.21" width="8.42" height="22.57" rx="3.67"
                        transform="matrix(0.08, -1, 1, 0.08, 11.74, 79.74)" />
                    <path class="grabbing-hand-finger-closed"
            ...
            <g class="weight-big-container">
                ...
                <g class="weight-big" stroke="none">
                    <path
                        ...
                        fill="#231f20" />
                    <path d="M15.1,15.6l-1.8-.2a9.2,9.2,0,0,0-9.1,9.2,6.2,6.2,0,0,0,.2,1.9A13.3,13.3,0,0,1,15.1,15.6Z"
                        fill="#fff" />
                </g>
            </g>
            ...
            <g class="scales-container">
                ...
                <defs>
                    <marker id="ball" viewBox="0 0 10 10" refX="5" refY="5" markerUnits="strokeWidth" markerWidth="5"
                ...
                <line class="scales-moving-line" x1="147.6" y1="30.52" x2="40" y2="12" stroke-width="2"
                    marker-start="url(#ball)" marker-end="url(#ball)" />
